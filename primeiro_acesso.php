			...
			<div class="col-md-6 col-md-offset-3">
				<div class="panel panel-login">
					...
					<div class="panel-body">
						<div class="row">
							<div class="col-lg-12">
								<form action="php/primeiro_acessophp.php" id="login-form" method="post"  role="form" style="display: block;">
									<div class="form-group">
										<input type="text" name="prontuario" id="prontuario" tabindex="1" class="form-control" placeholder="Prontuário" value="">
									</div>
									<div class="form-group">
